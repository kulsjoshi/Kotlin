...
import com.kuldeepjoshi.kotlintutorial.databinding.FragmentLetterListBinding
import com.kuldeepjoshi.kotlintutorial.navigationTutorial.adapter.LetterAdapterForNavigationModule
...
class LetterListFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recylerView.adapter = LetterAdapterForNavigationModule()
        chooseLayout()
