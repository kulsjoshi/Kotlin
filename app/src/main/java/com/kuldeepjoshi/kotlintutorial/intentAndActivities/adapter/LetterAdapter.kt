package com.kuldeepjoshi.kotlintutorial.intentAndActivities.adapter
...
import com.kuldeepjoshi.kotlintutorial.intentAndActivities.activity.LetterDetailsActivity

class LetterAdapter :
    RecyclerView.Adapter<LetterAdapter.CustomViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CustomViewHolder {
        ...
        layout.accessibilityDelegate = LetterDetailAdapter
    ...
    override fun onBindViewHolder(holder: CustomViewHolder, position: Int) {
        ...
        holder.button.setOnClickListener {
            ...
            Intent(mContext, LetterDetailsActivity::class.java).also {
                it.putExtra(WordsListFragment.LETTER, holder.button.text.toString())
