...
class LetterDetailAdapter(letterId: String, context: Context) :
    RecyclerView.Adapter<LetterDetailAdapter.CustomLetterDetailsAdapter>() {
    ...
    override fun onBindViewHolder(holder: CustomLetterDetailsAdapter, position: Int) {
        ...
        holder.button.setOnClickListener {
            val queryUrl: Uri =
                Uri.parse("${LetterDetailsActivity.SEARCH_PREFIX}${item}")
